...
// Using ssr: true for faster initial render
...
export default function DashboardPage() {
    ...
    // Removed debug useEffect to prevent re-render loops
            ...
            <header className="sticky top-0 z-50 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-b border-slate-200 dark:border-slate-700/50 transition-colors">
                <div className="flex items-center justify-between px-4 py-4">
                    <div className="flex items-center gap-3">
                        <div className="w-10 h-10 bg-gradient-to-br from-[#475569] to-[#334155] rounded-xl flex items-center justify-center shadow-lg shadow-slate-600/25">
                        ...
                        <div>
                            <h1 className="text-lg font-bold text-[#475569] dark:text-[#c9a96e]">Harmuni Plus</h1>
                            {loading ? (
                        ...
                        {profile?.role === 'admin' && (
                            <>
                                ...
                                <button
                                    ...
                                    className="flex items-center gap-1.5 px-3 py-2 bg-gradient-to-r from-[#475569] to-[#334155] hover:from-[#334155] hover:to-[#1e293b] text-white text-sm font-medium rounded-xl shadow-md shadow-slate-600/20 transition-all hover:scale-105 active:scale-95"
                                    title="مهمة جديدة"
                                >
                                ...
                                <button
                                    ...
                                    className="flex items-center gap-1.5 px-3 py-2 bg-gradient-to-r from-[#c9a96e] to-[#b8956a] hover:from-[#b8956a] hover:to-[#a78560] text-white text-sm font-medium rounded-xl shadow-md shadow-[#c9a96e]/20 transition-all hover:scale-105 active:scale-95"
                                    title="تعميم جديد"
                                >
                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div className="absolute left-0 top-full mt-2 w-80 max-h-96 overflow-y-auto bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-700 z-50">
                                            ...
                                            {notifications.length === 0 ? (
                                                ...
                                                notifications.slice(0, 5).map(notification => (
                                                    <div
                                                        ...
                                                        className={`p-3 border-b border-slate-100 dark:border-slate-700/50 cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-700/30 transition-colors ${!notification.is_read ? 'bg-[#c9a96e]/10 dark:bg-[#c9a96e]/10' : ''
                                                            }`}
                                                    >
                                                        <div className="flex items-start gap-3">
                                                            <div className={`w-2 h-2 mt-2 rounded-full flex-shrink-0 ${!notification.is_read ? 'bg-[#c9a96e]' : 'bg-slate-300 dark:bg-slate-600'
                                                                }`} />
                                        ...
                                        {notifications.length > 5 && (
                                            <button
                                                ...
                                                className="w-full p-3 text-center text-sm text-[#c9a96e] hover:bg-slate-50 dark:hover:bg-slate-700/30 transition-colors"
                                            >
    ...
    return (
        <button
            ...
            className={`relative flex flex-col items-center gap-1 px-4 py-2 rounded-xl transition-all ${active
                ? 'text-[#c9a96e] dark:text-[#c9a96e] bg-[#c9a96e]/10'
                : 'text-[#475569] hover:text-[#334155] dark:text-slate-400 dark:hover:text-slate-300'
                }`}
        >
            <div className="relative">
                {icon}
