    ...
    return (
        <div className="space-y-6">
            ...
            <div className="w-full">
                <div className="grid w-full grid-cols-3 lg:w-[400px] bg-slate-100 dark:bg-slate-800 p-1 rounded-lg mb-6">
                    <button
                ...
                {/* Circulars Content */}
                {activeTab === 'circulars' && (
                    <div className="text-center py-12 text-slate-500 animate-in fade-in zoom-in-95 duration-200">
